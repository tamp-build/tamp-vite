...
#pragma warning restore CS0649
    ...
    readonly string SonarProjectKey = "tamp-build_tamp-vite";
    ...
    Target Test => _ => _
        ...
        .Description("Unit tests only — integration tests need Vite + Vitest on PATH.")
        .Executes(() => DotNet.Test(s => s
            .SetProject(RootDirectory / "tests" / "Tamp.Vite.V5.Tests" / "Tamp.Vite.V5.Tests.csproj")
            .SetConfiguration(Configuration)
            .SetNoBuild(true)
    ...
    Target Pack => _ => _
        ...
        {
            s.SetProject(RootDirectory / "src" / "Tamp.Vite.V5" / "Tamp.Vite.V5.csproj");
